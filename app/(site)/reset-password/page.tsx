      ...
      <div className="mx-auto max-w-[560px] px-4 py-16">
        {!ok ? (
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <p className="text-sm text-black/70">for <strong>{email || "your account"}</strong></p>
            {err && <div className="rounded-md bg-red-50 px-3 py-2 text-sm text-red-700">{err}</div>}
            <label className="block">
              <span className="text-[12px] font-medium text-neutral-800">New password</span>
              <input
                type="password"
                required
                value={p1}
            ...
            <label className="block">
              <span className="text-[12px] font-medium text-neutral-800">Confirm password</span>
              <input
                type="password"
                required
                value={p2}
